...
import { setMoment } from "@/store/momentSlice";
...
interface PropsType {
  ...
  isHasNewNotice: boolean;
}
const MomentTemplate = ({ momentList, isHasNewNotice }: PropsType) => {
  ...
  return (
    <div>
      <div
        ...
        style={{
          height: `calc(100vh - ${commentInputVisible ? (isHasNewNotice ? "180" : "132") : "80"}px)`,
        }}
